...
Access with link:https://qiyuninr.shinyapps.io/PRISMA-Generator/
...
## 🏆 Credits & Attribution
  ...
  * **Design Standard:** The visual style, layout, and structural logic of the flow diagrams generated by this tool are based on the official [PRISMA 2020 Flow Diagram](https://www.prisma-statement.org/prisma-2020-flow-diagram) guidelines.
  * **Developer:** This application was designed and developed by **Qiyun Li** (liqiyun56@gmail.com).
